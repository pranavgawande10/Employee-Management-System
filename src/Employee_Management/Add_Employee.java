...
public class Add_Employee implements ActionListener {
    JLabel id, id1, id2, id3, id4, id5, id6, id7, id8, id9, id10, id11, id12;
    JFrame f;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == b) {
            ...
            try {
                ...
                String query = "INSERT INTO employee1 (name, fname, age, dob, address, phone, email, education, post, aadhar) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                PreparedStatement pst = obj.con.prepareStatement(query, Statement.RETURN_GENERATED_KEYS);
                ...
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Details Successfully Inserted!\nGenerated Employee ID: " + generatedId);
                }
